...
(function () {
  ...
  "exchange.title": "取引所",
  "exchange.desc": "集めたEmuerを、NFTと交換できます。",
  "exchange.loading": "交換できるNFTを読み込んでいます…",
  "exchange.freeLimit": "無料パスの方は、毎週月曜日のみ交換できます。",
  "exchange.unavailable": "いま取引所に接続できません。時間をおいて、もう一度お試しください。",
  "exchange.empty": "いま交換できるNFTはありません。",
  ...
  "exchange.desc": "Trade the Emuer you have earned for NFTs.",
  "exchange.loading": "Loading available NFTs…",
  ...
  "exchange.empty": "No NFTs are available right now.",
  ...
  "exchange.title": "交易所",
  "exchange.desc": "用累积的 Emuer 兑换 NFT。",
  "exchange.loading": "正在载入可兑换的 NFT…",
  "exchange.freeLimit": "免费通行证仅限每周一兑换。",
  "exchange.unavailable": "目前无法连接交易所，请稍后再试。",
  "exchange.empty": "目前没有可兑换的 NFT。",
  ...
  "exchange.title": "거래소",
  "exchange.desc": "모은 Emuer를 NFT와 교환할 수 있습니다.",
  "exchange.loading": "교환 가능한 NFT를 불러오는 중…",
  "exchange.freeLimit": "무료 패스는 매주 월요일에만 교환할 수 있습니다.",
  "exchange.unavailable": "지금은 거래소에 연결할 수 없습니다. 잠시 후 다시 시도해 주세요.",
  "exchange.empty": "지금 교환할 수 있는 NFT가 없습니다.",
  ...
  "exchange.title": "Bursa",
  "exchange.desc": "Tukarkan Emuer yang kamu kumpulkan dengan NFT.",
  "exchange.loading": "Memuat NFT yang tersedia…",
  "exchange.freeLimit": "Pemegang pass gratis hanya bisa menukar pada hari Senin.",
  "exchange.unavailable": "Bursa tidak dapat dihubungi saat ini. Coba lagi nanti.",
  "exchange.empty": "Belum ada NFT yang bisa ditukar.",
  "exchange.error": "Gagal memuat bursa. Coba lagi nanti.",
  "exchange.buyEmuer": "Tukar dengan Emuer",
  "exchange.buyJpyc": "Tukar dengan JPYC",
  "exchange.needWallet": "Hubungkan dompet untuk menukar.",
  "exchange.processing": "Memproses…",
  "exchange.success": "Penukaran selesai.",
